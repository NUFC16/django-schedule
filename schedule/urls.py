...
urlpatterns = patterns(
    ...
    url(r'^(?P<group_id>\d+)/(?P<swap_id>\d+)/reject_receiver/$', reject_receiver_swap, name='reject_receiver_swap_view'),
    url(r'^(?P<group_id>\d+)/(?P<swap_id>\d+)/confirm_receiver/$', confirm_receiver_swap, name='confirm_receiver_swap_view'),
